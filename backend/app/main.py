...
from app.routers import auth, condominios, concessionarias, faturas, alertas, emails, importacoes, relatorios, dashboard, contratos, reajustes, fornecedores, historico
